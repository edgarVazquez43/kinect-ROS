...
rosbag::Bag bag;
std::string topic_name_pc    = "/camera/depth_registered/points";
std::string topic_name_depth = "/camera/depth_registered/depth";
std::string topic_name_rgb   = "/camera/depth_registered/color";
...
{
  indexUser++;
  std::cout << "kinect.-> New user: " << indexUser << std::endl;
  indexVideo = 1;
}
...
int main(int argc, char** argv)
{
  ...
  ros::init(argc, argv, "rosbag_record_kinect");
  ros::NodeHandle n;
  //Subcribers
